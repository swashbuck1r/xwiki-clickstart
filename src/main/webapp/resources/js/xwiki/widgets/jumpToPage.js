...
$super(d);
if(typeof(c.widgets.Suggest)!="undefined"){new c.widgets.Suggest(this.input,{script:"${request.contextPath}/rest/wikis/${context.database}/search?scope=name&number=10&",varname:"q",noresults:"$msg.get('core.viewers.jump.suggest.noResults')",icon:"${xwiki.getSkinFile('icons/silk/page_white_text.png')}",json:true,resultsParameter:"searchResults",resultId:"id",resultValue:"pageFullName",resultInfo:"pageFullName",timeout:30000,parentContainer:this.dialogBox})
