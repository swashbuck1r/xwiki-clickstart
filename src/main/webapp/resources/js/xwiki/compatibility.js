...
Object.extend(XWiki.resource,{getWikiFromResourceName:function(b){if(b.include(XWiki.constants.wikiSpaceSeparator)){return b.substring(0,b.indexOf(XWiki.constants.wikiSpaceSeparator))
}return null
},getSpaceFromResourceName:function(c){var b=c;
if(c.include(XWiki.constants.wikiSpaceSeparator)){c=c.substring(c.indexOf(XWiki.constants.wikiSpaceSeparator)+1,c.length)
}if(c.include(XWiki.constants.spacePageSeparator)){if(c.include(XWiki.constants.pageAttachmentSeparator)&&c.indexOf(XWiki.constants.spacePageSeparator)>c.indexOf(XWiki.constants.pageAttachmentSeparator)){return null
}return c.substring(0,c.indexOf(XWiki.constants.spacePageSeparator))
}if(b.include(XWiki.constants.wikiSpaceSeparator)&&!b.include(XWiki.constants.pageAttachmentSeparator)&&!b.include(XWiki.constants.anchorSeparator)){return c
}return null
},getNameFromResourceName:function(c){var b=c;
if(c.include(XWiki.constants.wikiSpaceSeparator)){c=c.substring(c.indexOf(XWiki.constants.wikiSpaceSeparator)+1,c.length)
}if(c.include(XWiki.constants.pageAttachmentSeparator)){c=c.substring(0,c.indexOf(XWiki.constants.pageAttachmentSeparator))
}if(c.include(XWiki.constants.anchorSeparator)){c=c.substring(0,c.indexOf(XWiki.constants.anchorSeparator))
}if(c.include(XWiki.constants.spacePageSeparator)){return c.substring(c.indexOf(XWiki.constants.spacePageSeparator)+1,c.length)
}else{if(b.include(XWiki.constants.wikiSpaceSeparator)){return null
}else{return c
}}},getAttachmentFromResourceName:function(b){if(b.include(XWiki.constants.pageAttachmentSeparator)){return b.substring(b.indexOf(XWiki.constants.pageAttachmentSeparator)+1,b.length)
}return null
},getAnchorFromResourceName:function(b){if(b.include(XWiki.constants.anchorSeparator)){return b.substring(b.indexOf(XWiki.constants.anchorSeparator)+1,b.length)
}return null
}});
